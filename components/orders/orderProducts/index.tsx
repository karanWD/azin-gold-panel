        ...
        return (
          <Box className="products-container" key={"ORDER_PRODUCT_ITEM_" + index}>
            <Box className="products-name-container">
              <Typography component="p" variant={"subtitle3"} className="products-name">{item.header}</Typography>
              <Typography component="p" variant={"caption"} className="products-wage">
                اجرت:
                {item.wage}
                درصد
              </Typography>
                  ...
                  return (
                    <Box className="product-item-container" key={"ORDER_SUBPRODUCT_ITEM_" + index}>
                      <Box display="flex" alignItems="center" gap="8px">
                        ...
                        <Typography  variant="caption" className="product-item-weight">({productItem.weight} گرم )</Typography>
                      </Box>
                      <Box display="flex" alignItems="center" gap="40px">
                        <Box display="flex" alignItems="center" gap="8px">
                          <Typography variant="caption" className="product-item-info-title">
                            وزن کل حدودی با اجرت:
                          </Typography>
                          <Typography variant="subtitle3" className="product-item-info-value">
